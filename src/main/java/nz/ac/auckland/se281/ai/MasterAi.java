...
public class MasterAi extends Player implements Ai {
  ...
  public void setStrategy() {
    if (round <= 3) {
      ...
      // On the fourth and every even round, play average
      strategy = new AverageStrategy(history);
    } else {
      // On the fifth and every odd round, play top
      this.strategy = new TopStrategy(history);
    }
  }
